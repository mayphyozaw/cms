...
@section('content')
    <div class="content" style="padding-top: 0 !important;">
        <div class="d-flex align-items-center justify-content-between gap-2 mb-2 mt-0 flex-wrap">
            <div>
                <h4 class="mb-1">Labor Type Lists<span class="badge badge-soft-primary ms-2">{{$laborTypes->count()}}</span></h4>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Home</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Labor Type Lists</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="card border-0 rounded-0">
            <div class="card-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h5 class="card-title mb-0">Labor Type Lists</h5>
                    </div>

                    <div class="col-auto">
                        <x-create-button href="{{ route('labor.type.create') }}">
                            Create Labor Type
                        </x-create-button>
                    </div>
                </div>
                                ...
                                <tr class="text-center">
                                    ...
                                    <td class="text-center">
                                        <a class="btn btn-icon btn-sm btn-info"
                                            href="{{ route('labor.type.edit', $type->id) }}">
                                            <i class="ti ti-edit"></i>
                                        </a>
                                        <form action="{{ route('labor.type.destroy', $type->id) }}"
