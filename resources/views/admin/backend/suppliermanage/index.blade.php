...
@section('content')
    <div class="content pb-0">
        <div class="mb-4">
            <h4 class="mb-1">Supplier Informations</h4>
        ...
        <div class="card border-0 rounded-0">
            ...
            <div class="card-header">
                <div class="row align-items-center">
                    ...
                    <div class="col-auto">
                        <x-create-button href="{{ route('suppliermanage.supplier.create') }}">
                            Create Supplier
                        </x-create-button>
                    </div>
                </div>
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table id="datatable"
                        class="table supplierTable table-bordered dt-responsive table-responsive table-hover text-nowrap">
                        <thead>
                            <tr>
    ...
    <script>
        $(document).ready(function() {
            var table = $('.supplierTable').DataTable({
                ...
                paging: true,
                ajax: {
                    url: "{{ route('suppliermanage.supplier-datatable') }}",
                    type: "GET"
                },
                columns: [{
                        data: 'DT_RowIndex',
