            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('material.variableassets.index') }}">Material Rate
                            History</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Create Material Rate</li>
                </ol>
            </nav>
        </div>
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-12 md-12">
                <div class="card border-0 rounded-0">
                    ...
                    <div class="card-body">
                        <form action="{{ route('material.rate.store') }}" method="POST" id="submit-form"
...
@endsection
@push('scripts')
    {!! JsValidator::formRequest('App\Http\Requests\MaterialRate\RateStoreRequest', '#submit-form') !!}
    <script>
        $('.select2').select2({
            width: '100%'
        });
