...
@section('content')
    <div class="content pb-0">
        <div class="mb-4">
            <h4 class="mb-1">Permission Informations</h4>
        ...
        <div class="card border-0 rounded-0">
            ...
            <div class="card-header">
                <div class="row align-items-center">
                    ...
                    <div class="col-auto">
                        <x-create-button href="{{ route('configuration.permission.create') }}">
                            Create Permission
                        </x-create-button>
                    </div>
                </div>
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table id="datatable"
                        class="table permissionTable table-bordered dt-responsive table-responsive table-hover text-nowrap">
                        <thead>
                            <tr>
    ...
    <script>
        $(document).ready(function() {
            var table = $('.permissionTable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('configuration.permission-datatable') }}",
                    type: 'GET'
                },
                columns: [{
                        data: 'DT_RowIndex',
