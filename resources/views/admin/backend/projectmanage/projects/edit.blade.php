                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="text" class="form-control" name="length" id="length"
                                    value="{{ old('length', $project->client->length) }}" readonly>
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="text" class="form-control" name="width" id="width"
                                    value="{{ old('width', $project->client->width) }}" readonly>
                            </div>
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="text" class="form-control" name="storeys" id="storeys"
                                    value="{{ old('storeys', $project->client->storeys) }}" readonly>
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <select class="form-control select2" name="job_scope" id="job_scope">
                                    ...
                                    <option value="Plumbing"
                                        ...
                                        Plumbing</option>
                                    <option value="PAE"
                                        {{ old('job_scope', $project->client->job_scope) == 'PAE' ? 'selected' : '' }}>
                                        PAE
                                    </option>
                                    <option value="Steel"
                                        {{ old('job_scope', $project->client->job_scope) == 'Steel' ? 'selected' : '' }}>
                                        Steel
                                        Structure</option>
                                </select>
                            </div>
                            ...
                            <div class="col-md-3 mb-3">
                                <label class="form-label">
                                    Project Type: </label>
                                <select class="form-control select2" name="project_type" id="project_type">
