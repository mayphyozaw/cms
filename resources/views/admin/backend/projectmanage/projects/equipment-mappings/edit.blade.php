        ...
        <div class="row justify-content-center">
            ...
            <div class="col-xl-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('projectmanage.projects.equipment-mappings.update', [$project->id, $equipmentMapping->id]) }}"
                                        ...
                                        <select name="drawing_measurement_id" class="form-control select2"
                                            ...
                                            @foreach ($drawingMeasurements as $drawingMeasurement)
                                                <option value="{{ $drawingMeasurement->id }}"
                                                    {{ $equipmentMapping->drawing_measurement_id == $drawingMeasurement->id ? 'selected' : '' }}>
                                        ...
                                        <select name="equipment_id" id="equipment_id" class="form-control select2">
                                            ...
                                            @foreach ($equipments as $equipment)
                                                <option value="{{ $equipment->id }}"
                                                    {{ $equipmentMapping->equipment_id == $equipment->id ? 'selected' : '' }}>
                                                    {{ $equipment->name }}
                                                </option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <input type="text" id="equipment_category_name" class="form-control" readonly value="{{$equipmentMapping->equipmentCategory?->name}}">
                                </div>
                            </div>
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group">
                                        <select name="productivity_unit" class="form-control select2" id="productivity_unit">
                                            ...
                                            <option value='CFT/Day' {{ $equipmentMapping->productivity_unit == 'CFT/Day' ? 'selected' : '' }}> CFT/Day</option>
                                            <option value='CFT/Hour' {{ $equipmentMapping->productivity_unit == 'CFT/Hour' ? 'selected' : '' }}> CFT/Hour </option>
                                            <option value='M3/Day' {{ $equipmentMapping->productivity_unit == 'M3/Day' ? 'selected' : '' }}> M3/Day </option>
                                            <option value='M3/Hour' {{ $equipmentMapping->productivity_unit == 'M3/Hour' ? 'selected' : '' }}> M3/Hour </option>
                                            <option value='SQFT/Day' {{ $equipmentMapping->productivity_unit == 'SQFT/Day' ? 'selected' : '' }}> SQFT/Day </option>
                                            <option value='SQFT/Hour' {{ $equipmentMapping->productivity_unit == 'SQFT/Hour' ? 'selected' : '' }}> SQFT/Hour </option>
                                            <option value='Ton/Day' {{ $equipmentMapping->productivity_unit == 'Ton/Day' ? 'selected' : '' }}> Ton/Day </option>
                                            <option value='Ton/Hour' {{ $equipmentMapping->productivity_unit == 'Ton/Hour' ? 'selected' : '' }}> Ton/Hour </option>
                                            <option value='Nos/Day' {{ $equipmentMapping->productivity_unit == 'Nos/Day' ? 'selected' : '' }}> Nos/Day </option>
                                            <option value='Nos/Hour' {{ $equipmentMapping->productivity_unit == 'Nos/Hour' ? 'selected' : '' }}> Nos/Hour </option>
                                            <option value='Hour/Day' {{ $equipmentMapping->productivity_unit == 'Hour/Day' ? 'selected' : '' }}> Hour/Day </option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3" id="coverage_qty_div">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group">
                                        <input type="text" name="productivity" class="form-control" step="0.01" value="{{$equipmentMapping->productivity}}">
                                    </div>
                                </div>
                            </div>
