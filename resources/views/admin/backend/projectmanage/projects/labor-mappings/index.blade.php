                ...
                <div class="card mb-0">
                    ...
                    <div class="card-header">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col">
                                <h5 class="card-title mb-0">Labor Mappings Lists</h5>
                            </div>

                            <div class="col-auto">
                                <x-create-button
                                    href="{{ route('projectmanage.projects.labor-mappings.create', $project->id) }}">
                                    Create Labor Mappings
                                </x-create-button>
                            </div>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($laborMappings as $laborMapping)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                {{ $laborMapping->drawingmeasurement?->category?->category_name ?? 'N/A' }}
                                            </td>
                                           ...
                                           <td class="text-center">
                                            ...
                                            <td class="text-center">
                                                {{ number_format($laborMapping->productivity, 2) }}
                                            ...
                                            <td class="text-center">
                                                <a class="btn btn-icon btn-sm btn-info"
                                                    href="{{ route('projectmanage.projects.labor-mappings.edit', [$project->id, $laborMapping->id]) }}">
                                                    <i class="ti ti-edit"></i>
                                                </a>
                                                <form
                                                    action="{{ route('projectmanage.projects.labor-mappings.destroy', [$project->id, $laborMapping->id]) }}"
