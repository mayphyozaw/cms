                ...
                <div class="card mb-0">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col">
                                <h5 class="card-title mb-0">Drawing Type</h5>
                            </div>

                            <div class="col-auto">
                                <x-create-button href="{{ route('projectmanage.projects.drawing-type.create', $project->id) }}">
                                    Create Drawing Type
                                </x-create-button>
                            </div>
                        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a class="btn btn-icon btn-sm btn-info"
                                                        href="{{ route('projectmanage.projects.drawing-type.edit', [$project->id, $drawing_type->id]) }}">
                                                        <i class="ti ti-edit"></i>
                                                    </a>
                                                    <form
                                                        action="{{ route('projectmanage.projects.drawing-type.destroy', [$project->id, $drawing_type->id]) }}"
