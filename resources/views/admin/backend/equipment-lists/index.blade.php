...
@section('content')
    <div class="content" style="padding-top: 0 !important;">
        <div class="d-flex align-items-center justify-content-between gap-2 mb-2 mt-0 flex-wrap">
            <div>
                <h4 class="mb-1">Equipment Lists<span class="badge badge-soft-primary ms-2">{{$equipments->count()}}</span></h4>
                    ...
                    <table id="datatable"
                        ...
                        <thead>
                            <tr>
                                ...
                                <th class="text-center" style="background-color: #9dd2e7">Equipment Code</th>
                        ...
                        <tbody>
                            @foreach ($equipments as $equipment)
                                <tr class="text-center">
                                    ...
                                    <td>{{ $equipment->eqCategory->name }}</td>
                                    <td>{{ $equipment->boqCategory->name }}</td>
