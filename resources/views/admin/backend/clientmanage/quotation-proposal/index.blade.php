                                    ...
                                    @foreach ($proposalAllData as $proposal)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <span
                                                    class="badge {{ $status == 'Accepted' ? 'bg-success' : ($status == 'Requested' ? 'bg-teal' : ($status == 'Draft' ? 'bg-warning' : 'bg-danger')) }}">
                                                    {{ $status }}
                                                </span>
                                            </td>
                                            ...
                                            <td class="text-center">
                                                <div class="dropdown table-action">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        ...
                                                        <a class="dropdown-item"
                                                            href="{{ route('clientmanage.detail.quotation-proposal', $proposal->id) }}">
