                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td class="py-3" id="subtotalDisplay"
                                                                    name="subtotal_amount" style="text-align:end">
                                                                    0.00 MMK
                                                                </td>
                                            ...
                                            <table class="table table-bordered" id="paymentTermsTable">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="text-center"
                                                            style="background-color: #9dd2e7;width:7%">
                                                            Percentage (%)
                                                        </th>
                                                        <th class="text-center"
                                                            style="background-color: #9dd2e7;width:20%">
                                                        ...
                                                        <th class="text-center"
                                                            style="background-color: #9dd2e7;width:15%">
                                                            Amount
                                                        </th>
                                                        <th class="text-center"
                                                        ...
                                                        <th class="text-center"
                                                            style="background-color: #9dd2e7;width:8%">
                                                            Date
                                                        </th>
                                                        <th class="text-center"
                                                            style="background-color: #9dd2e7; width: 5%">
                                                            Action
                                                        </th>
                                                    </tr>
                                                </thead>
