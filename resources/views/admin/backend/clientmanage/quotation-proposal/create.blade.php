                                        ...
                                        <table class="table table-bordered">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="py-3" id="subtotalDisplay" name="subtotal_amount"
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="py-3" id="taxDisplay" style="text-align:end"> 0.00 MMK
                                                    </td>
                                ...
                                <table class="table table-bordered" id="paymentTermsTable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" name="payment_terms[0][amount]"
