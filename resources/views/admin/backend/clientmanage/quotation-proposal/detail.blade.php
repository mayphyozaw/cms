                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center justify-content-between border-1 border-bottom pb-3 mb-3">
                                ...
                                <div class="mt-5">
                                    <h5 class="justify-content-center">Quotation Proposal</h5>
                                </div>
                                <div>
                            ...
                            <div class="row pb-3 border-1 border-bottom mb-4">
                                ...
                                <div class="col-lg-8">
                                    ...
                                    <div class="d-flex mb-1 fw-semibold">
                                        <div style="width: 150px;">Customer Contact No</div>
                                        <div class="me-2">:</div>
                                        <div class="text-dark">{{ $proposalData->client->phone }}</div>
                                    </div>

                                    <div class="d-flex mb-1 fw-semibold">
                                        <div style="width: 150px;">Site Location</div>
                                        <div class="me-2">:</div>
                                        <div class="text-dark">{{ $proposalData->client->site_location }}</div>
                                    </div>

                                    <div class="d-flex mb-1 fw-semibold">
                                        <div style="width: 150px;">Work Scope</div>
                                        <div class="me-2">:</div>
                                        <div class="text-dark">{{ $proposalData->main_subject }}</div>
                                    </div>
                                </div>

                                <div class="col-lg-4">

                                    <h5 class="mb-2 fs-14 fw-medium">Date : {{ $proposalData->proposal_date }} </h5>
                                    <h5 class="mb-2 fs-14 fw-medium">Payment Status <span
                                            class="badge bg-danger">{{ $proposalData->status }}</span></h5>
                                        ...
                                        <table class="proposal-table table-bordered">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="width:15%">Price (MMK)</th>
                                                    <th style="width:15%">Total (MMK)</th>
                            ...
                            <div class="pb-3 mb-3 border-1 border-bottom ">
                                <div class="row align-items-center">
                                    <div class="col-lg-6">
                                        <div>
                                            <div class=" mb-3">
                                                <h6 class="mb-1 fs-14 fw-semibold"> Specifications Inclusive: </h6>
                                        ...
                                        <div>
                                            <div
                                                ...
                                                <h6 class="fs-14 fw-medium mb-0">
                                                    {{ number_format($proposalData->subtotal_amount, 2) }} MMK</h6>
                                            </div>
                                            <div
                                                class="d-flex align-items-center justify-content-between border-bottom pb-2 mb-2">
                                                <h6 class="fs-14 fw-medium mb-0">Discount</h6>
                                                <h6 class="fs-14 fw-medium mb-0">
                                                    <span
                                            ...
                                            <div class="d-flex align-items-center justify-content-between mb-3">
                                                <h6 class="fs-14 fw-medium mb-0">Tax(%)</h6>
                                                <h6 class="fs-14 fw-medium mb-0">
                                                    {{ number_format($proposalData->tax_amount, 2) }} MMK</h6>
                                            </div>
                                            <div class="d-flex align-items-center justify-content-between mb-1">
                                                <h6 class="mb-0">TotalAmount</h6>
                                                <h6 class="mb-0">{{ number_format($proposalData->total_amount, 2) }} MMk
                                                </h6>
                                            </div>
                            ...
                            <div class="text-end border-bottom mb-3 pb-3">
                                <div>
                                    <img src="{{ asset('backend/assets/img/icons/signature-img.svg') }}" alt="Img"
                                        class="img-fluid ">
                                    <h6 class="fs-14 fw-semibold"> May Phyo </h6>
                            ...
                            <div class="pb-3 mb-3 border-1 border-bottom">
                                ...
                                <div>
                                    <table style="width:60%; font-size: 14px; border-collapse: collapse;">
                                        <tr>
                                            <td style="width:3%;">•</td>
                                            <td>စာချုပ်ချုပ်ဆိုသည့် နေ့တွင်</td>
                                            <td style="text-align:right;"> - စာချုပ်ငွေ ပမာဏ ၏ <span class="fw-semibold">
                                                    ၅၀%</span> ရာခိုင်နှုန်း </td>
                                        </tr>
                                        <tr>
                                            <td>•</td>
                                ...
                                <div class="py-3">
                                    <table class="table table-bordered" style="border-collapse: collapse; width: 100%;">
                                        <thead class="table-light table-bordered">
                                            <tr>
                                                <th class="text-center" style="background-color:#9dd2e7">စဉ်</th>
                                                <th class="text-center" style="background-color:#9dd2e7; width:20%">
                                                    အကြောင်းအရာ</th>
                                                <th class="text-center" style="background-color:#9dd2e7;width:15%">
                                                    လုပ်ငန်း ပြီးစီးမှုအလိုက် ပေးချေရမည့် ရာခိုင်နှုန်း</th>
                                                <th class="text-center" style="background-color:#9dd2e7;width:20%">ငွေပမာဏ
                                                </th>
                                                <th class="text-center" style="background-color:#9dd2e7">ငွေပေးချေသူ
                                                    (လုပ်ငန်းအပ်နှံသူ)</th>
                                                <th class="text-center" style="background-color:#9dd2e7">ငွေလက်ခံသူ
                                                    (လုပ်ငန်းလက်ခံသူ)</th>
                                                <th class="text-center" style="background-color:#9dd2e7;width:15%">နေ့စွဲ
                                                </th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-center">စာချုပ်ချုပ်ဆိုသည့် နေ့</td>
                                ...
                                <div class="text-center border-bottom pb-3 mb-3">
                                    ...
                                    <p class="fs-13 mb-1">Payment Made Via bank transfer / Cheque in the name of May Phyo
                                    </p>
                                    <div class="d-flex align-items-center justify-content-center gap-3 flex-wrap">
                                        <p class="mb-0">Bank Name : <span class="text-dark">ABC Bank</span></p>
                                    ...
                                    <div class="py-4">
                                        ...
                                        <table class="table table-bordered text-nowrap" style="width: 100%">
                                            <thead>
                                                <tr>
                                                    <th style="background-color: #9dd2e7">Bank</th>
                                                    <th style="background-color: #9dd2e7">Account Number</th>
                                                    <th style="background-color: #9dd2e7">Bank Number</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <tr>
                            ...
                            <div class="text-center d-flex align-items-center justify-content-end">
                                <a href="#" class="btn btn-md btn-light me-2 d-flex align-items-center">
                                    <i class="ti ti-copy me-1"></i>Invoice</a>
