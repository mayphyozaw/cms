        ...
        <div class="mb-4">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Damage Assets</li>
                </ol>
            </nav>
        </div>
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-12 md-12">
                <div class="card border-0 rounded-0">
                    ...
                    <div class="card-body">
                        <form action="{{ route('material.asset.damage', $asset->id) }}" method="GET" id="submit-form"
                            ...
                            <div class="col-lg-6 col-md-12">
                                <div class="mb-3">
                                    <label class="form-label fs-14">Total Damage Quantity</label>
                                    <div class="input-group">
