    ...
    <div class="modal fade" id="addModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('material.category.store') }}" method="POST" id="add-form">
                    @csrf
...
@push('scripts')
    {!! JsValidator::formRequest('App\Http\Requests\FixedAssets\CategoryStoreRequest', '#add-form') !!}

    {!! JsValidator::formRequest('App\Http\Requests\FixedAssets\CategoryUpdateRequest', '#edit-form') !!}
    ...
    <script>
        $(document).ready(function() {
            var table = $('.categoryTable').DataTable({
                ...
                paging: true,
                ajax: {
                    url: "{{ route('material.category-datatable') }}",
                    type: "GET"
                },
