                ...
                let html = `
                        <tr class="item-row" data-section="${currentSection}">
                            ...
                            <td colspan="2">
                             ...
                             <td>
                                <input type="hidden" name="rows[${itemRowIndex}][variable_asset_id]" class="form-control variable_asset_id">
                                <select name="rows[${itemRowIndex}][material_requirement_id]" 
                                    class="form-control material_requirement_id select2">
                                   <option value="">
                            ...
                            <td>
                                <input type="hidden"name="rows[${itemRowIndex}][boq_category_id]" class="boq_category_id">
                                <input type="text"class="form-control boq_category_name"readonly>
                            </td>
