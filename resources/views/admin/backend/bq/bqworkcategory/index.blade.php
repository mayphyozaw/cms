        ...
        <div class="card border-0 rounded-0">
                ...
                <div class="row align-items-center">
                    <div class="col">
                        <h5 class="card-title mb-0">
                            BQ Work Category Information
                        </h5>
                    </div>
                    <div class="col-auto">
                        <x-create-button href="{{ route('bq.bqworkcategory.create') }}">
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table id="datatable" class="table bqworkcategoryTable table-bordered table-responsive table-hover text-nowrap">
                        <thead>
                            <tr>
