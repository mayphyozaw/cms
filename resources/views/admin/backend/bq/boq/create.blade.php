            ...
            <div class="col-xl-9">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title">BOQ Information</h5>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('projectmanage.projects.boq.store', $project->id) }}" method="POST"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group">
                                        <input type="date" class="form-control" name="boq_date" id="boq_date">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="revision_no" id="revision_no">
                                    </div>
                                </div>
                            </div>
