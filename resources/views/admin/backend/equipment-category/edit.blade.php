        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-12 md-12">
                <div class="card border-0 rounded-0">
                    ...
                    <div class="card-body">
                        <form action="{{ route('equipment.category.update', $eqCategory->id) }}" method="POST" id="submit-form"
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control"
                                            name="name" value="{{$eqCategory->name}}">
                                    </div>
                                </div>
                            </div>
...
@endsection
@push('scripts')
    {!! JsValidator::formRequest('App\Http\Requests\Equipment\CategoryUpdateRequest', '#submit-form') !!}
