                        ...
                        <div class="col-lg-6 col-md-12">
                            <div class="mb-3">
                                ...
                                <select class="form-control" name="employeetype" data-choices data-choices-search-false
                                    ...
                                    <option value="Contract"{{$user->employeetype === 'Contract' ? 'selected' : ''}}>Contract</option>
                                    <option value="Probation"{{$user->employeetype === 'Probation' ? 'selected' : ''}}>Probation</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-12">
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="date" name="joindate" value="{{ old('joindate', $user->joindate ? \Carbon\Carbon::parse($user->joindate)->format('Y-m-d') : '') }}>"
                                        class="form-control">
                                </div>
                            </div>
                        </div>
